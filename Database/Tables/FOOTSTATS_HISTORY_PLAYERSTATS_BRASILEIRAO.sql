CREATE TABLE "FOOTSTATS"."FOOTSTATS_HISTORY_PLAYERSTATS_BRASILEIRAO" 
(	
...
CREATE UNIQUE INDEX "FOOTSTATS"."SYS_C0031737" ON "FOOTSTATS"."FOOTSTATS_HISTORY_PLAYERSTATS_BRASILEIRAO" ("Hash_ID", "Created_Date") 
...
ALTER TABLE "FOOTSTATS"."FOOTSTATS_HISTORY_PLAYERSTATS_BRASILEIRAO" MODIFY ("Player" NOT NULL ENABLE);
ALTER TABLE "FOOTSTATS"."FOOTSTATS_HISTORY_PLAYERSTATS_BRASILEIRAO" MODIFY ("Nation" NOT NULL ENABLE);
ALTER TABLE "FOOTSTATS"."FOOTSTATS_HISTORY_PLAYERSTATS_BRASILEIRAO" MODIFY ("Position" NOT NULL ENABLE);
ALTER TABLE "FOOTSTATS"."FOOTSTATS_HISTORY_PLAYERSTATS_BRASILEIRAO" MODIFY ("Squad" NOT NULL ENABLE);
ALTER TABLE "FOOTSTATS"."FOOTSTATS_HISTORY_PLAYERSTATS_BRASILEIRAO" MODIFY ("Age" NOT NULL ENABLE);
ALTER TABLE "FOOTSTATS"."FOOTSTATS_HISTORY_PLAYERSTATS_BRASILEIRAO" MODIFY ("Created_Date" NOT NULL ENABLE);
ALTER TABLE "FOOTSTATS"."FOOTSTATS_HISTORY_PLAYERSTATS_BRASILEIRAO" ADD PRIMARY KEY ("Hash_ID", "Created_Date")
